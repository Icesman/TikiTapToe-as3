package
{
    ...
    public class Root extends Sprite
    {
        ...
        private function showScene(screen:Class,data:Object = null):void
        {
            if (mActiveScene) mActiveScene.removeFromParent(true);
            mActiveScene = new screen();
			if (mActiveScene is Game) {
				if (_gameMode == "single") {
					Game(mActiveScene).playervscpu = true;
				}  else {
					Game(mActiveScene).playervscpu = false;
				}
